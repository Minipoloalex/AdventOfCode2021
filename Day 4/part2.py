# -*- coding: utf-8 -*-
"""
Created on Fri Aug 19 16:26:04 2022
...
def main():
    ...
    final_value, unmarked_sum = get_loser_board(drawn_nums, boards)
...
def get_loser_board(drawn_nums, boards):    # Last winning board
    for number_str in drawn_nums:
        ...
        for remove_board in to_remove:
            boards.remove(remove_board)
